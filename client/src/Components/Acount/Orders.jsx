...
function createData(orden, fecha, articulos, costo, delivery, total) {
  return {
    orden,
    fecha,
    articulos,
    ...
    products: [
      {
        imagen: 'https://d3ugyf2ht6aenh.cloudfront.net/stores/001/760/094/products/buzo11-483ac84fbd0bfd134a16560222693507-240-0.png',
        producto: 'REMERA X',
        categoria: 'ONE PICE',
        color:'Negro',
        talla:"XL",
      ...
      {
        imagen: 'https://d3ugyf2ht6aenh.cloudfront.net/stores/001/760/094/products/negro1-d4f6c74a307b89eaf616481572825390-240-0.png',
        producto: 'REMERA X',
  ...
  return (
    <React.Fragment>
      <TableRow  sx={{ '& > *': { borderBottom: 'unset' } }} >
        ...
        <StyledTableCell component="th" scope="row">{row.orden}</StyledTableCell>
                  ...
                  {row.products.map((productsRow) => (
                    <TableRow key={productsRow.producto}>
                      <TableCell component="th" scope="row">
                        <CardMedia component="img" height="80" image={productsRow.imagen} alt="Product" />
                      </TableCell>
                      <TableCell>{productsRow.producto}</TableCell>
                      <TableCell align="center">{productsRow.categoria}</TableCell>
                      <TableCell align="center">{productsRow.color}</TableCell>
                      <TableCell align="center">{productsRow.talla}</TableCell>
                      <TableCell align="center">{productsRow.cantidad}</TableCell>
